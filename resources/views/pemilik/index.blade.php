                    ...
                    <div class="row">
                        <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-xl-0">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    <h4 class="font-weight-bolder mb-0">{{rupiah($pengeluaranYear)}}</h4>
                                    <p class="card-text font-small-3 mb-1">Tahun ini <small>({{date('Y')}})</small></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-xl-0">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    <h4 class="font-weight-bolder mb-0">{{rupiah($pengeluaranMonth)}}</h4>
                                    <p class="card-text font-small-3 mb-1">Bulan ini <small>({{date('F')}})</small> </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-sm-0">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    <h4 class="font-weight-bolder mb-0">{{rupiah($pengeluaranPrevYear)}}</h4>
                                    <p class="card-text font-small-3 mb-1">Tahun sebelumnya <small>({{date("Y",strtotime("-1 year")) ?? 0}})</small></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-md-3 col-6">
                    <div class="card">
                        <div class="card-body pb-50">
                            ...
                            <h2 class="font-weight-bolder mb-1"><i class="feather icon-dollar-sign" class="avatar-icon"></i> {{rupiah($pengeluaran)}}</h2>
                        </div>
                    </div>
                </div>
            </div>
